...
export function validateBody<T>(schema: ZodType<T>, body: unknown): Either<HttpError, T> {
 ...
 */
export function validateParams<T>(schema: ZodType<T>, params: unknown): Either<HttpError, T> {
