...
export const SPLIT_ERRORS: Record<SplitError, HttpError> = {
  ...
  not_an_expense: {
    status: 400,
    code: 'not_an_expense',
    message: 'Só é possível dividir uma despesa.',
  },
  unsupported_method: {
    status: 400,
    code: 'unsupported_method',
    message:
      'Essa transação não pode ser dividida (precisa ter uma conta de origem).',
  },
  already_split: {
    status: 409,
    code: 'already_split',
    message: 'Essa transação já tem um split ativo.',
  },
  no_participants: {
    status: 400,
    code: 'no_participants',
    message: 'Informe ao menos um participante.',
  },
  ...
  invalid_amount: {
    status: 400,
    code: 'invalid_amount',
    message: 'Valor inválido pra um dos participantes.',
  },
