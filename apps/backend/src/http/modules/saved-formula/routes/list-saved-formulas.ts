...
import { listSavedFormulas } from '../../../../application/use-cases/saved-formula';
...
export const listSavedFormulasRoute = (deps: AppDeps) =>
  new Elysia().get(
    ...
    async ({ request, params, set }) => {
      ...
      return listSavedFormulas(deps, auth.value);
    }
  );
