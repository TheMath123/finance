...
export function Select({
  ...
  const isNewArch = !!(globalThis as { nativeFabricUIManager?: unknown })
  ...
  return (
    ...
    <View collapsable={false} className={className}>
      <Pressable
        ref={triggerRef}
        className={cn(
          'flex-row items-center justify-between h-12 px-4 border border-input rounded-lg bg-background active:bg-accent/30',
          className
        )}
        onPress={handleOpen}
        accessible={true}
