 ...
 * resumo mensal já carregado na tela, sem round-trip pro backend a cada
 * toque no teclado. A avaliação final ao salvar continua sendo validada
 * pelo backend (essa aqui é só feedback visual). Espelha
 * apps/dashboard/src/lib/formula-catalog.ts.
 *
