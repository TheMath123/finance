...
export const interUserTransferStatusEnum = pgEnum(
  'inter_user_transfer_status',
...
export const interUserTransfersRelations = relations(
  interUserTransfers,
  ({ one }) => ({
    fromUser: one(users, {
      fields: [interUserTransfers.fromUserId],
      references: [users.id],
    }),
    toUser: one(users, {
      fields: [interUserTransfers.toUserId],
      references: [users.id],
    }),
